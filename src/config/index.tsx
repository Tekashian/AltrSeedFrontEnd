...
import { mainnet, sepolia, type Chain } from "@reown/appkit/networks"; // lub z wagmi/chains
...
export const networks = [sepolia] as const; // Użycie `as const` dla lepszego typowania
...
export const wagmiAdapter = new WagmiAdapter({
  ...
  networks: networks as unknown as [Chain, ...Chain[]],
